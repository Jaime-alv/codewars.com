...
object HiddenCubicNumbers extends App {
  /*
  ...
  */
  ...
  println(cubicNumbers("aqdf&0#1xyz!22[153(777.777"))
  println(cubicNumbers("QK29a45[&erui9026315"))
}
